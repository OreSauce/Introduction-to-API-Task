...
function renderPosts() {
    ...
    for (let post of postsArray) {
        ...
        <div class="card mb-3 mt-2">
          <div class="row g-0">
            <div class="col-md-4">
              <img src="https://images.unsplash.com/photo-1554744512-d6c603f27c54?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dGVzbGF8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" class="img-fluid rounded-start h-100 w-100" alt="...">
            </div>
            <div class="col-md-8">
              <div class="card-body">
                ...
                <a href="./view.html?id=${post.id}" class="btn btn-success">View <i class="bi bi-binoculars-fill"></i></a>
